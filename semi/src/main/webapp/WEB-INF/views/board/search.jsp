...
<body>
	...
	<div class="main">
		...
		<form action="${ contextPath }/result.bo" method="post" class="main">
			<h1 id="join">What do you want to join?</h1>
			<br>
			<div class="question" name="category" >
			<select name="categoryClass" id="categoryname">
		  		<option value="" disabled selected>===카테고리 선택===</option>
		  		<option value="art"> 문화/예술</option>
				<option value="exercise"> 운동/액티비티</option>
				<option value="food"> 푸드/드링크</option>
				<option value="hobby"> 취미</option>
				<option value="party"> 파티/소게팅</option>
				<option value="travel"> 여행/동행</option>
				<option value="develop"> 성장/자기계발</option>
				<option value="country"> 동네/또래</option>
				<option value="investment"> 재태크</option>
				<option value="language"> 외국어</option>
			</select>
			</div>
			<br>
			<div class="question" name="joinname">
				<input type="text" name="clubName" placeholder="모임이름">
			</div>
			<br>
			<div class="question" name="writername" >
				<input type="text" name="creatorName"  placeholder="작성자 이름">
			</div>
			<br>
			<div class="question" name="date" >
				<input type="date" name="clubScheduleOG" placeholder="모임날짜">
			</div>
			<br>
			<div class="question" name="addr" placeholder="모임장소">
			...
			<br>
			<div class="question" name="search" style="display: inline-block;">
